    ...
    public static Map<String, AtomicInteger> getJsonObjectWithIdsAsMap() {
        ...
        try {
            ...
            for (Map.Entry<?, ?> entry : map.entrySet()) {
                mapToReturn.put(entry.getKey().toString(), new AtomicInteger(Integer.parseInt(String.valueOf(
                        Math.round(Float.parseFloat(entry.getValue().toString()))))));
            }
